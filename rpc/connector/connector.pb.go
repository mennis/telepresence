...
var file_rpc_connector_connector_proto_rawDesc = []byte{
	...
	0x6f, 0x52, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x22, 0xad, 0x02, 0x0a,
	...
	0x61, 0x64, 0x4b, 0x69, 0x6e, 0x64, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0x28, 0x0a, 0x0c,
	...
	0x9d, 0x0e, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x43, 0x0a,
	...
	0x63, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x43, 0x6f, 0x6d,
	0x6d, 0x61, 0x6e, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x12, 0x63, 0x0a, 0x0a, 0x52, 0x75,
...
var file_rpc_connector_connector_proto_goTypes = []interface{}{
	...
	(*manager.AgentInfoSnapshot)(nil),          // 35: telepresence.manager.AgentInfoSnapshot
	...
	(*manager.IngressInfo)(nil),                // 38: telepresence.manager.IngressInfo
...
var file_rpc_connector_connector_proto_depIdxs = []int32{
	...
	35, // 3: telepresence.connector.ConnectInfo.agents:type_name -> telepresence.manager.AgentInfoSnapshot
	36, // 4: telepresence.connector.ConnectInfo.intercepts:type_name -> telepresence.manager.InterceptInfoSnapshot
	37, // 5: telepresence.connector.ConnectInfo.session_info:type_name -> telepresence.manager.SessionInfo
	38, // 6: telepresence.connector.IngressInfos.ingress_infos:type_name -> telepresence.manager.IngressInfo
	...
	39, // 8: telepresence.connector.CreateInterceptRequest.spec:type_name -> telepresence.manager.InterceptSpec
	3,  // 9: telepresence.connector.ListRequest.filter:type_name -> telepresence.connector.ListRequest.Filter
	40, // 10: telepresence.connector.WorkloadInfo.agent_info:type_name -> telepresence.manager.AgentInfo
	41, // 11: telepresence.connector.WorkloadInfo.intercept_info:type_name -> telepresence.manager.InterceptInfo
	...
	34, // 20: telepresence.connector.WorkloadInfo.ServiceReference.ports:type_name -> telepresence.connector.WorkloadInfo.ServiceReference.Port
	42, // 21: telepresence.connector.Connector.Version:input_type -> google.protobuf.Empty
	...
	42, // 24: telepresence.connector.Connector.Status:input_type -> google.protobuf.Empty
	13, // 25: telepresence.connector.Connector.CanIntercept:input_type -> telepresence.connector.CreateInterceptRequest
	13, // 26: telepresence.connector.Connector.CreateIntercept:input_type -> telepresence.connector.CreateInterceptRequest
	43, // 27: telepresence.connector.Connector.RemoveIntercept:input_type -> telepresence.manager.RemoveInterceptRequest2
	11, // 28: telepresence.connector.Connector.Uninstall:input_type -> telepresence.connector.UninstallRequest
	14, // 29: telepresence.connector.Connector.List:input_type -> telepresence.connector.ListRequest
	15, // 30: telepresence.connector.Connector.WatchWorkloads:input_type -> telepresence.connector.WatchWorkloadsRequest
	42, // 31: telepresence.connector.Connector.UserNotifications:input_type -> google.protobuf.Empty
	20, // 32: telepresence.connector.Connector.Login:input_type -> telepresence.connector.LoginRequest
	42, // 33: telepresence.connector.Connector.Logout:input_type -> google.protobuf.Empty
	22, // 34: telepresence.connector.Connector.GetCloudUserInfo:input_type -> telepresence.connector.UserInfoRequest
	24, // 35: telepresence.connector.Connector.GetCloudAPIKey:input_type -> telepresence.connector.KeyRequest
	26, // 36: telepresence.connector.Connector.GetCloudLicense:input_type -> telepresence.connector.LicenseRequest
	42, // 37: telepresence.connector.Connector.GetIngressInfos:input_type -> google.protobuf.Empty
	...
	42, // 40: telepresence.connector.Connector.ListCommands:input_type -> google.protobuf.Empty
	6,  // 41: telepresence.connector.Connector.RunCommand:input_type -> telepresence.connector.RunCommandRequest
	45, // 42: telepresence.connector.Connector.Version:output_type -> telepresence.common.VersionInfo
	9,  // 43: telepresence.connector.Connector.Connect:output_type -> telepresence.connector.ConnectInfo
	42, // 44: telepresence.connector.Connector.Disconnect:output_type -> google.protobuf.Empty
	9,  // 45: telepresence.connector.Connector.Status:output_type -> telepresence.connector.ConnectInfo
	18, // 46: telepresence.connector.Connector.CanIntercept:output_type -> telepresence.connector.InterceptResult
	18, // 47: telepresence.connector.Connector.CreateIntercept:output_type -> telepresence.connector.InterceptResult
	18, // 48: telepresence.connector.Connector.RemoveIntercept:output_type -> telepresence.connector.InterceptResult
	12, // 49: telepresence.connector.Connector.Uninstall:output_type -> telepresence.connector.UninstallResult
	17, // 50: telepresence.connector.Connector.List:output_type -> telepresence.connector.WorkloadInfoSnapshot
	17, // 51: telepresence.connector.Connector.WatchWorkloads:output_type -> telepresence.connector.WorkloadInfoSnapshot
	19, // 52: telepresence.connector.Connector.UserNotifications:output_type -> telepresence.connector.Notification
	21, // 53: telepresence.connector.Connector.Login:output_type -> telepresence.connector.LoginResult
	42, // 54: telepresence.connector.Connector.Logout:output_type -> google.protobuf.Empty
	23, // 55: telepresence.connector.Connector.GetCloudUserInfo:output_type -> telepresence.connector.UserInfo
	25, // 56: telepresence.connector.Connector.GetCloudAPIKey:output_type -> telepresence.connector.KeyData
	27, // 57: telepresence.connector.Connector.GetCloudLicense:output_type -> telepresence.connector.LicenseData
	10, // 58: telepresence.connector.Connector.GetIngressInfos:output_type -> telepresence.connector.IngressInfos
	42, // 59: telepresence.connector.Connector.SetLogLevel:output_type -> google.protobuf.Empty
	42, // 60: telepresence.connector.Connector.Quit:output_type -> google.protobuf.Empty
	5,  // 61: telepresence.connector.Connector.ListCommands:output_type -> telepresence.connector.CommandGroups
	7,  // 62: telepresence.connector.Connector.RunCommand:output_type -> telepresence.connector.RunCommandResponse
